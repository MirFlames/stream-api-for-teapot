...
public class CrazyStreams {
    ...
    public Optional<Account> findRichestPerson() {
        return accounts
                .stream()
                .max((account1, account2) -> account1.getBalance().subtract(account2.getBalance()).signum());
    }
    ...
    public Map<String, List<Account>> groupAccountsByEmailDomain() {
        return accounts
                .stream()
                .collect(Collectors.groupingBy(e -> getEmailDomain(e.getEmail())));
    }
    ...
    public BigDecimal calculateTotalBalance() {
        return accounts
                ...
                .reduce(BigDecimal.ZERO.stripTrailingZeros(), BigDecimal::add);
    }
    ...
    public boolean containsAccountWithEmailDomain(String emailDomain) {
        return accounts
                .stream()
                .anyMatch(e -> getEmailDomain(e.getEmail()).equals(emailDomain));
    }
    ...
    public Map<Month, String> groupCommaSeparatedFirstNamesByBirthdayMonth() {
        return accounts
                ...
                .collect(Collectors.groupingBy(e -> e.getBirthday().getMonth(),
                        HashMap::new,
                        Collectors.collectingAndThen(Collectors.mapping(Account::getFirstName, Collectors.toList()),
                                e -> String.join(", ", e))));
    }
    ...
    public Map<Month, BigDecimal> groupTotalBalanceByCreationMonth() {
        return accounts
                ...
                .collect(Collectors.groupingBy(e -> e.getCreationDate().getMonth(),
                        HashMap::new,
                        Collectors.reducing(BigDecimal.ZERO.stripTrailingZeros(),
                                Account::getBalance,
                                BigDecimal::add)));
    }
    ...
    public Map<Character, Long> getCharacterFrequencyInFirstNames() {
        return accounts
                .stream()
                .flatMapToInt(e -> e.getFirstName().chars())
                .mapToObj(e -> (char) e)
